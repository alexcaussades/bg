  ...
  @endauth
    ...
    <div class="card text-white bg-dark mt-2">
      <div class="card-body">
        ...
        <p class="card-text"> Le réglage au taux de CH4 selon la cible  :  <a href="{{ route("reglage.index") }}"><button class="btn btn-info" type="submit"><i class="bi bi-arrow-right-circle"></i> Plus d'infos </button></a></p>
      </div>
    </div>
