...
@section('title', "RegBio - Importer un rapport Kizeo Biogaz")
@section("content")


<div class="container mt-5">
<h3>Importer un rapport Kizeo Biogaz</h3>
...
<form method="POST" action="{{ route('kizeo.import_kizeo_biogaz') }}" enctype="multipart/form-data" >
