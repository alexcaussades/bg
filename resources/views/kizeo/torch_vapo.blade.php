...
@section('title', "RegBio - Importer un rapport Torch & Vapo")
@section("content")


<div class="container mt-5">
<h3>Importer un rapport Kizeo Torch & Vapo</h3>
...
<form method="POST" action="{{ route('kizeo.import_kizeo_torch_vapo') }}" enctype="multipart/form-data" >
